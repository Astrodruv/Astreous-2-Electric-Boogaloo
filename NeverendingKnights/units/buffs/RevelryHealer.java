...
public class RevelryHealer extends NeverendingKnightsUnit {
    ...
    public Unit getBestUnitToHeal(){
        ...
        for (Unit u : getAlliesInRadius(1000)){
            if (!u.hasCondition(Revelry.class) && !u.hasWeapon(RepairBeam.class) && !u.getFrame().equals(Frame.COLOSSAL)
